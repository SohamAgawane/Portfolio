...
export default function HeroSection({ isPlaying }) {
  ...
  const showGrid = shouldBeColorful;
      ...
      <div className="max-w-7xl mx-auto w-full">
        ...
        >
          ...
          <motion.div
            ...
            className={`p-6 sm:p-10 lg:p-12 border-b lg:border-b-0 lg:border-r ${
              isDark
          ...
          >
            ...
            >
              ...
              <p className="text-sm leading-relaxed opacity-70 mt-2 max-w-xl">
